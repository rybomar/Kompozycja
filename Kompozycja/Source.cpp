...
int main(int argc, char * argv[]){
	string manual = " resFilePath firstImgPath bandNumInFirstImg [nextImgPath bandNumInNextImg]*\n Wynik zapisywany z dokaadnoacia FLOAT_32. Obrazy musza miec takie same wymiary w px. Nie nadpisuje istniejacych plikow.";
